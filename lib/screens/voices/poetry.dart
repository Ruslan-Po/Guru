...
class _PoetryVoiceState extends State<PoetryVoice> {
  ...
  Widget _buildText() {
    String textToShow = "";
    TextStyle style = AppTextStyles.poetryAnswer;
    ...
    if (_displayState == DisplayState.aiAnswer) {
      ...
      style = AppTextStyles.poetryAnswer;
      fadeIn = Duration.zero;
      fadeOut = Duration.zero;
    } else {
      textToShow = _recognizedText;
          ...
          children: [
            ...
            Positioned(
              ...
              child: Row(
                ...
                crossAxisAlignment:
                    CrossAxisAlignment.center, // Центровка по вертикали
                children: [
                  // Назад
                  IconButton(
                    onPressed: () {
                  ...
                  GestureDetector(
                    ...
                    child: GlowingMicPainterWrapper(
                      ...
                      glowColor: const Color(0xFFC47AD6), // Фиолетовый
                      child: SizedBox(
                        width: micSize,
                        height: micSize,
